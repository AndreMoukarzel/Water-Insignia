...
var char_database = [
	{ # ID = 0
		...
		DEF :   [5,  6,  7,  7,  10, 12, 12, 13, 2, 6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
	...
	{ # ID = 1
		...
		DEF :   [3,  5,  6,  8,  10, 11, 13, 14, 2, 6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
	...
	{ # ID = 3
		...
		ATK :   [4,  6,  9,  11, 15, 18, 21, 23, 2, 6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
		SPATK : [0,  2,  5,  7,  10, 12, 15, 19, 3, 3, 1, 1, 1, 2, 1, 1, 2, 1, 1, 5],
		DEF :   [2,  5,  7,  10, 13, 15, 17, 20, 2, 6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
		SPDEF : [0,  3,  4,  7,  8,  11, 12, 15, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
		SPD :   [1,  3,  4,  5,  8,  11, 14, 15, 2, 6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
		DEX :   [1,  2,  4,  6,  9,  11, 13, 14, 2, 6, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
