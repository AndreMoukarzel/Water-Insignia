...
var char_database = [
	...
	{ # ID = 3
		...
		ATK :   [6,  8,  11, 13, 17, 20, 23, 25, 27, 30, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
		SPATK : [1,  3,  6,  8,  11, 13, 16, 20, 23, 26, 1, 1, 1, 2, 1, 1, 2, 1, 1, 5],
		DEF :   [4,  7,  9,  12, 15, 17, 19, 22, 25, 28, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
		SPDEF : [1,  4,  5,  6,  9,  12, 13, 16, 18, 20, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
		SPD :   [3,  5,  6,  7,  10, 13, 16, 17, 18, 21, 1, 1, 1, 1, 1, 1, 1, 1, 1, 15],
